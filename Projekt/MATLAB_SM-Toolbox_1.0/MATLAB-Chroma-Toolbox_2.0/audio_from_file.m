function [f_audio,sideinfo] = audio_from_file(dirAbs,dirRel,wavfilename,parameter)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Name: audio_from_file
% Date of Revision: 2011-03
% Programmer: Meinard Mueller, Sebastian Ewert
% Date of modification: 19.01.2018
% Modifier: Micha³ Kleszczyñski, Beata Kotra
%
% Description:
...
% Modification by Micha³ Kleszczyñski, Beata Kotra
