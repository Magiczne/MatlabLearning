...
% Figure 4 - Wyg³adzanie z róznic¹ przedzia³u, dwustronne
...
visualizeSM(S,paramVis);            % Figure 5 - Wyg³adzanei z ró¿nic¹ przedzia³u + circShift
visualizeTransIndex(I,paramVis);    % Figure 6 - indeksy

% TU sie w sumie wycina szumy, w sensie jakaœ kompresja czy cholera wie co
% Figure 7
